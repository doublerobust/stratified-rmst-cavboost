...
\date{May 30, 2026\newline\small Full simulation results (500 reps)}
...
Results from 500 Monte Carlo reps (200 agent server, 300 Omen):

\begin{center}
\begin{tabular}{lcccc}
\toprule
\multicolumn{5}{c}{Hold-out AUC (SE)} \\
\cmidrule{2-5}
Scenario (boundary) & Orig & \textbf{StratCF} & VT & Gain \\
\midrule
S1: Linear ($S_1 > 0$) & 0.790 (0.003) & \textbf{0.974} (0.001) & 0.872 (0.002) & +0.185 \\
S2: Diff ($S_1 - S_2 > 0$) & 0.793 (0.002) & \textbf{0.943} (0.001) & 0.760 (0.001) & +0.150 \\
S3: U-shaped ($S_1$) & 0.905 (0.002) & \textbf{0.987} (0.001) & 0.867 (0.002) & +0.082 \\
S4: Enclave ($S_1 \times S_2$) & \textbf{0.888} (0.002) & 0.805 (0.002) & 0.960 (0.001) & $-$0.083 \\
S5: S-shaped ($S_1$, disjoint) & \textbf{0.951} (0.002) & 0.947 (0.002) & 0.786 (0.002) & $-$0.005 \\
S6: Cross ($S_1 \times S_2$) & 0.921 (0.003) & \textbf{0.936} (0.004) & 0.775 (0.004) & +0.015 \\
\midrule
\emph{Average} & 0.875 & \textbf{0.932} & 0.837 & +0.057 \\
\bottomrule
\end{tabular}
\footnotesize Combined results from 500 reps per scenario (200 agent server, 300 Omen).
\end{center}
...
\toprule
 & \multicolumn{3}{c}{Original RMSTBoost} & \multicolumn{3}{c}{\textbf{StratCF}} & \multicolumn{3}{c}{Virtual Twin} \\
\cmidrule{2-4}\cmidrule{5-7}\cmidrule{8-10}
Scenario & Acc & Sens & Spec & Acc & Sens & Spec & Acc & Sens & Spec \\
\midrule
S1: Linear & 0.722 & 0.771 & 0.674 & \textbf{0.917} & \textbf{0.921} & \textbf{0.913} & 0.781 & 0.678 & 0.885 \\
S2: Diff & 0.719 & 0.760 & 0.677 & \textbf{0.856} & \textbf{0.882} & \textbf{0.830} & 0.689 & 0.604 & 0.774 \\
S3: U-shaped & 0.822 & 0.906 & 0.740 & \textbf{0.953} & \textbf{0.987} & \textbf{0.919} & 0.789 & 0.748 & 0.829 \\
S4: Enclave & 0.802 & \textbf{0.967} & 0.618 & 0.755 & 0.973 & 0.513 & \textbf{0.891} & 0.909 & \textbf{0.870} \\
S5: S-shaped & \textbf{0.889} & 0.927 & \textbf{0.852} & 0.882 & \textbf{0.932} & 0.833 & 0.716 & 0.773 & 0.659 \\
S6: Cross & 0.861 & 0.897 & 0.811 & \textbf{0.912} & \textbf{0.950} & \textbf{0.859} & 0.706 & 0.768 & 0.620 \\
\bottomrule
\end{tabular}
\footnotesize Optimal cutpoint $p = 0.5$. Combined results from 500 reps per scenario (200 agent server, 300 Omen).
\end{center}
...
\begin{itemize}
  \item \textbf{Stratified RMSTBoost dominates on additive and monotone
        boundaries} (S1--S3, gains of 8--19 AUC points).  The cross-fitted
        ...
        clean signal, producing near-perfect AUC values on S1 (0.974) and S3 (0.987).

  \item \textbf{Stratification is detrimental on disjoint interaction
        boundaries} (S4 Enclave: StratCF 0.805 vs.\ Orig 0.888).  The
  ...
  \item \textbf{On complex but connected boundaries} (S5 S-shaped, S6
        Cross), the stratified method is approximately neutral (S5: $-$0.005,
        S6: $+$0.015).  The prognostic score partly captures the structure
        but not cleanly enough to produce a large gain.

  \item \textbf{The stratified method never collapses}.  Across all six
        scenarios, the worst-case loss relative to the original is 8.3 AUC points (S4).  In no scenario does it fall below 0.80, and over 99\% of reps produce correctly directed predictions across all scenarios.
