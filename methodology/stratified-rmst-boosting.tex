...
compared: original CAVBoost, stratified CAVBoost ($K=4$, cross-fitted
...
\toprule
 & & \multicolumn{3}{c}{Hold-out AUC (SE)} & & \% Correct Dir. \\
\cmidrule{3-5}
...
\begin{itemize}
  \item \textbf{Stratified CAVBoost dominates on additive and monotone
  ...
  \item \textbf{Original CAVBoost is robust} (0.79--0.95 AUC), making it a
...
The results suggest a practical rule: \textbf{use stratified CAVBoost
...
computationally efficient modification of the original CAVBoost
